...
export function CourseDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#F8F9FF] to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <button 
            onClick={() => navigate("/courses")}
            className="flex items-center gap-2 text-[#4F46E5] hover:text-[#4338ca] mb-6 transition-colors"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4">
                <img 
                  src={`https://ui-avatars.com/api/?name=${course.instructor}&background=4F46E5&color=fff`}
